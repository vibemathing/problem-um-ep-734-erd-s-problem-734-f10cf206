...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-734-erd-s-problem-734-f10cf206-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-734"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-734-erd-s-problem-734-f10cf206-v1",
      "problem_contract_sha256": "924814e6e112d21e94c25edd9528fe8d034630f2cd781f7bc9f76c7288f384dd",
      "problem_id": "problem:um-ep-734-erd-s-problem-734-f10cf206",
      "route_id": "route:um-ep-734-erd-s-problem-734-f10cf206-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-734-erd-s-problem-734-f10cf206-source-fidelity-01",
      "graph_id": "graph:um-ep-734-erd-s-problem-734-f10cf206-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-734-erd-s-problem-734-f10cf206-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-734-erd-s-problem-734-f10cf206-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Find, for all large $n$, a non-trivial pairwise balanced block design $A_1,\\ldots,A_m\\subseteq \\{1,\\ldots,n\\}$ such that, for all $t$, there are $O(n^{1/2})$ many $i$ such that $\\lvert A_i\\rvert=t$."
          },
          "statement_sha256": "011372d2d7540f8e4c69db0df969891436b06b2979af743801bf3c57c0d91ecd"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-734-erd-s-problem-734-f10cf206-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-734-erd-s-problem-734-f10cf206-root",
      "route_id": "route:um-ep-734-erd-s-problem-734-f10cf206-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-734-2ae2674e6fab",
        "url": "https://www.unsolvedmath.com/problems/EP-734"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
